...
def get_nli(data_path):
    ...
    for data_type in ['train', 'dev', 'test']:
        ...
        if data_type=='dev':
            dt='train'
        s1[data_type]['path'] = os.path.join(data_path, 'data.' + dt)
        s2[data_type]['path'] = os.path.join(data_path, 'data.' + dt)
        ...
        s1[data_type]['sent'] = [line.rstrip() for line in
                                 open(s1[data_type]['path'], encoding='utf-8')]
        s2[data_type]['sent'] = [line.rstrip() for line in
                                 open(s2[data_type]['path'], encoding='utf-8')]
