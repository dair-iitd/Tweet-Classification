...
# paths
parser.add_argument("--nlipath", type=str, default='', help="NLI data path (SNLI or MultiNLI)")
parser.add_argument("--outputdir", type=str, default='savedir/', help="Output directory")
parser.add_argument("--outputmodelname", type=str, default='model.pickle')
parser.add_argument("--word_emb_path", type=str, default="glove.twitter.27B.100d.txt", help="word embedding file path")
...
word_vec = build_vocab(train['s1']+
                       valid['s1']+
                       test['s1'], params.word_emb_path)
...
# loss
weight = torch.FloatTensor((1.0,3.0))
print(weight)
...
def trainepoch(epoch):
    ...
    train_acc = np.round(100 * correct/(1+len(s1)), 2)
    print('results : epoch {0} ; mean accuracy train : {1}'
          .format(epoch, train_acc))
    return train_acc

final_file=open("labels.predicted","w")
