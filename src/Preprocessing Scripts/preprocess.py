...
# print(preprocess("RT @amnestyOz Over 10,000 people made the call for a Human Rights Act for Australia. There's still time. http://tr.im/ov90 \""))
with io.open(outfile, 'w') as tweet_processed_text, io.open(infile, 'r') as fin:
    for line in fin:
        # u = unicode(preprocess(line.strip())+"\n", "utf-8")
        # print(u)
